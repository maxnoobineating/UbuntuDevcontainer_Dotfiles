...
export PATH=/home/linuxbrew/.linuxbrew/bin:/home/linuxbrew/.linuxbrew/sbin:/root/.local/bin:/home/linuxbrew/.linuxbrew/bin:/home/linuxbrew/.linuxbrew/sbin:/root/.deno/bin:/root/.nvm/versions/node/v22.0.0/bin:/root/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/root/.local/bin:/opt/nvim-linux-x86_64/bin:/root/go/bin:/usr/local/go/bin:/root/ctags:/root/.fzf/bin:/opt/nvim-linux-x86_64/bin:/root/go/bin:/usr/local/go/bin:/root/ctags:/root/.claude/plugins/cache/claude-plugins-official/clangd-lsp/1.0.0/bin
